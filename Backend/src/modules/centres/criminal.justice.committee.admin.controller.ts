...
export const getCommittee = async (req: Request, res: Response) => {
  try {
    ...
    console.error("Criminal Justice getCommittee error:", error);
...
export const createMember = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error("Criminal Justice createMember error:", error);
    res.status(500).json({ error: "Internal server error" });
  }
};
...
export const updateMember = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error("Criminal Justice updateMember error:", error);
    res.status(500).json({ error: "Internal server error" });
  }
};
...
export const deleteMember = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error("Criminal Justice deleteMember error:", error);
    res.status(500).json({ error: "Internal server error" });
  }
};
